...
static const oe_ecall_info_t _tls_server_ecall_info_table[] = 
{
    { "generate_keypair" },
    { "set_up_tls_server" },
    { "unseal_data" },
...
oe_result_t tls_server_generate_keypair(
    ...
    size_t* out_sealed_size)
{
    ...
    /* Marshalling struct. */
    generate_keypair_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.out_sealed_blob = out_sealed_blob;
    _args.out_sealed_size = out_sealed_size;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(generate_keypair_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(generate_keypair_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (generate_keypair_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_generate_keypair].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (generate_keypair_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(tls_server_generate_keypair, generate_keypair);

oe_result_t tls_server_set_up_tls_server(
    oe_enclave_t* enclave,
    int* _retval,
    char* port,
    char* uuid_str)
{
    ...
    /* Marshalling struct. */
    set_up_tls_server_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    _args.uuid_str = uuid_str;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(set_up_tls_server_args_t));
    if (port)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.port_len, sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(set_up_tls_server_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (set_up_tls_server_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (port)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_set_up_tls_server].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (set_up_tls_server_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(tls_server_set_up_tls_server, set_up_tls_server);

oe_result_t tls_server_unseal_data(
    oe_enclave_t* enclave,
    uint8_t* sealed_blob,
    size_t sealed_size)
{
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.sealed_blob = sealed_blob;
    _args.sealed_size = sealed_size;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_unseal_data].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_server_unseal_data, unseal_data);

oe_result_t tls_server_free_tls(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    free_tls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(free_tls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(free_tls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (free_tls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_free_tls].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (free_tls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(tls_server_free_tls, free_tls);

oe_result_t tls_server_handle_communication_until_done(
    oe_enclave_t* enclave,
    int* _retval,
    bool keep_server_up,
    char* additional_input)
{
    ...
    /* Marshalling struct. */
    handle_communication_until_done_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.keep_server_up = keep_server_up;
    _args.additional_input = additional_input;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(handle_communication_until_done_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(handle_communication_until_done_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (handle_communication_until_done_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_handle_communication_until_done].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (handle_communication_until_done_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_server_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t tls_server_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_server_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t tls_server_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_server_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t tls_server_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_server_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t tls_server_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_server_ecall_info_table[tls_server_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_server_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
    ...
    size_t* output_bytes_written)
{
    ...
    if (_pargs_in->msg)
        OE_SET_IN_POINTER(msg, _pargs_in->msg_len, sizeof(char), char*);
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _tls_server_ocall_function_table,
               88,
               _tls_server_ecall_info_table,
                11,
               enclave);
}
