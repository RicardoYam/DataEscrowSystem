...
static const oe_ecall_info_t _tls_client_ecall_info_table[] = 
{
    { "launch_tls_client" },
...
oe_result_t tls_client_launch_tls_client(
    ...
    char* server_port)
{
    ...
    if (server_name)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.server_name_len, sizeof(char));
    if (server_port)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.server_port_len, sizeof(char));
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_client_ecall_info_table[tls_client_fcn_id_launch_tls_client].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_client_launch_tls_client, launch_tls_client);

oe_result_t tls_client_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_client_ecall_info_table[tls_client_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_client_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t tls_client_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_client_ecall_info_table[tls_client_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_client_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t tls_client_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_client_ecall_info_table[tls_client_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_client_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t tls_client_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_client_ecall_info_table[tls_client_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_client_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t tls_client_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _tls_client_ecall_info_table[tls_client_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(tls_client_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
enum
{
    ...
    tls_client_fcn_id_oe_syscall_fsync_ocall = 15,
    tls_client_fcn_id_oe_syscall_fdatasync_ocall = 16,
    tls_client_fcn_id_oe_syscall_dup_ocall = 17,
    tls_client_fcn_id_oe_syscall_opendir_ocall = 18,
    tls_client_fcn_id_oe_syscall_readdir_ocall = 19,
    tls_client_fcn_id_oe_syscall_rewinddir_ocall = 20,
    tls_client_fcn_id_oe_syscall_closedir_ocall = 21,
    tls_client_fcn_id_oe_syscall_stat_ocall = 22,
    tls_client_fcn_id_oe_syscall_fstat_ocall = 23,
    tls_client_fcn_id_oe_syscall_access_ocall = 24,
    tls_client_fcn_id_oe_syscall_link_ocall = 25,
    tls_client_fcn_id_oe_syscall_unlink_ocall = 26,
    tls_client_fcn_id_oe_syscall_rename_ocall = 27,
    tls_client_fcn_id_oe_syscall_truncate_ocall = 28,
    tls_client_fcn_id_oe_syscall_ftruncate_ocall = 29,
    tls_client_fcn_id_oe_syscall_mkdir_ocall = 30,
    tls_client_fcn_id_oe_syscall_rmdir_ocall = 31,
    tls_client_fcn_id_oe_syscall_fcntl_ocall = 32,
    tls_client_fcn_id_oe_syscall_ioctl_ocall = 33,
    tls_client_fcn_id_oe_syscall_poll_ocall = 34,
    tls_client_fcn_id_oe_syscall_kill_ocall = 35,
    tls_client_fcn_id_oe_syscall_close_socket_ocall = 36,
    tls_client_fcn_id_oe_syscall_socket_ocall = 37,
    tls_client_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 38,
    tls_client_fcn_id_oe_syscall_socketpair_ocall = 39,
    tls_client_fcn_id_oe_syscall_connect_ocall = 40,
    tls_client_fcn_id_oe_syscall_accept_ocall = 41,
    tls_client_fcn_id_oe_syscall_bind_ocall = 42,
    tls_client_fcn_id_oe_syscall_listen_ocall = 43,
    tls_client_fcn_id_oe_syscall_recvmsg_ocall = 44,
    tls_client_fcn_id_oe_syscall_sendmsg_ocall = 45,
    tls_client_fcn_id_oe_syscall_recv_ocall = 46,
    tls_client_fcn_id_oe_syscall_recvfrom_ocall = 47,
    tls_client_fcn_id_oe_syscall_send_ocall = 48,
    tls_client_fcn_id_oe_syscall_sendto_ocall = 49,
    tls_client_fcn_id_oe_syscall_recvv_ocall = 50,
    tls_client_fcn_id_oe_syscall_sendv_ocall = 51,
    tls_client_fcn_id_oe_syscall_shutdown_ocall = 52,
    tls_client_fcn_id_oe_syscall_setsockopt_ocall = 53,
    tls_client_fcn_id_oe_syscall_getsockopt_ocall = 54,
    tls_client_fcn_id_oe_syscall_getsockname_ocall = 55,
    tls_client_fcn_id_oe_syscall_getpeername_ocall = 56,
    tls_client_fcn_id_oe_syscall_getaddrinfo_open_ocall = 57,
    tls_client_fcn_id_oe_syscall_getaddrinfo_read_ocall = 58,
    tls_client_fcn_id_oe_syscall_getaddrinfo_close_ocall = 59,
    tls_client_fcn_id_oe_syscall_getnameinfo_ocall = 60,
    tls_client_fcn_id_oe_syscall_nanosleep_ocall = 61,
    tls_client_fcn_id_oe_syscall_clock_nanosleep_ocall = 62,
    tls_client_fcn_id_oe_syscall_getpid_ocall = 63,
    tls_client_fcn_id_oe_syscall_getppid_ocall = 64,
    tls_client_fcn_id_oe_syscall_getpgrp_ocall = 65,
    tls_client_fcn_id_oe_syscall_getuid_ocall = 66,
    tls_client_fcn_id_oe_syscall_geteuid_ocall = 67,
    tls_client_fcn_id_oe_syscall_getgid_ocall = 68,
    tls_client_fcn_id_oe_syscall_getegid_ocall = 69,
    tls_client_fcn_id_oe_syscall_getpgid_ocall = 70,
    tls_client_fcn_id_oe_syscall_getgroups_ocall = 71,
    tls_client_fcn_id_oe_syscall_uname_ocall = 72,
    tls_client_fcn_id_oe_get_supported_attester_format_ids_ocall = 73,
    tls_client_fcn_id_oe_get_qetarget_info_ocall = 74,
    tls_client_fcn_id_oe_get_quote_ocall = 75,
    tls_client_fcn_id_oe_get_quote_verification_collateral_ocall = 76,
    tls_client_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 77,
    tls_client_fcn_id_oe_verify_quote_ocall = 78,
    tls_client_fcn_id_oe_sgx_get_cpuid_table_ocall = 79,
    tls_client_fcn_id_oe_sgx_backtrace_symbols_ocall = 80,
    tls_client_fcn_id_oe_sgx_log_backtrace_ocall = 81,
    tls_client_fcn_id_oe_sgx_thread_wake_wait_ocall = 82,
    tls_client_fcn_id_oe_sgx_wake_switchless_worker_ocall = 83,
    tls_client_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 84,
    tls_client_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 85,
    tls_client_fcn_id_oe_verify_tdx_quote_ocall = 86,
...
static oe_ocall_func_t _tls_client_ocall_function_table[] = {
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _tls_client_ocall_function_table,
               87,
               _tls_client_ecall_info_table,
                6,
               enclave);
}
