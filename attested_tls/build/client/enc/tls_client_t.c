    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    launch_tls_client_args_t* _pargs_in = (launch_tls_client_args_t*)input_buffer;
    launch_tls_client_args_t* _pargs_out = (launch_tls_client_args_t*)output_buffer;
    ...
    if (_pargs_in->server_name)
        OE_SET_IN_POINTER(server_name, _pargs_in->server_name_len, sizeof(char), char*);
    if (_pargs_in->server_port)
        OE_SET_IN_POINTER(server_port, _pargs_in->server_port_len, sizeof(char), char*);
    ...
    OE_CHECK_NULL_TERMINATOR(_pargs_in->server_name, _pargs_in->server_name_len);
    OE_CHECK_NULL_TERMINATOR(_pargs_in->server_port, _pargs_in->server_port_len);

    /* lfence after checks. */
    oe_lfence();

    /* Call user function. */
    _pargs_out->oe_retval = launch_tls_client(
        _pargs_in->server_name,
        _pargs_in->server_port);
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_syscall_fsync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_syscall_fdatasync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_syscall_fstat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_syscall_ftruncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_syscall_clock_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t qe_identity_issuer_chain_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_verify_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_sgx_log_backtrace_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    tdx_quote_collateral_t* collateral)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_get_tdx_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t* p_supplemental_data_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             tls_client_fcn_id_oe_verify_tdx_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
